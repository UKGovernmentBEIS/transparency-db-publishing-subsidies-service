...
public class AccessManagementConstant {
    ...
    public static String REGIONS[] = {"UK-wide", "GB-wide", "England", "Northern Ireland", "Scotland", "Wales", "North East", "North West", "Yorkshire and Humber", "East Midlands", "West Midlands", "East of England", "London", "South East", "South West"};
