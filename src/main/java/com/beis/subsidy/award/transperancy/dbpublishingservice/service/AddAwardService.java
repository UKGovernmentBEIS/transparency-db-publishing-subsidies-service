...
public class AddAwardService {
	 ...
	 */
	public SingleAwardValidationResults validateAward(SingleAward award, String role,String accessToken,String grantingAuthorityGroupId,String userName) {
			...
			if (validationResult.getValidationErrorResult().size() == 0) {
		        ...
		        for (UserResponse userResponse : users) {
		      	  ...
		      	  try {
		  			...
		  			EmailUtils.sendSingleAwardEmail(userResponse.getMail(),userName,String.valueOf(savedAward.getAwardNumber()));
